...
export const serviceDetailPagesZhTw = {
  ...
  'web-development': {
    seo: {
      ...
      description:
        '雷力科技提供面向工業營運的網頁開發服務，協助企業將 SCADA / HMI、PI Server、Historians、告警、報表與後台流程整合成可維護、可擴充的瀏覽器端平台。'
    },
    heroFocusItems: [],
    introParagraphs: [
      '雷力科技提供面向工業營運的網頁開發服務，協助企業將 SCADA / HMI、PI Server、Historians、告警、報表與後台流程整合成易於使用的瀏覽器端平台，讓現場、維運、管理與資訊團隊能以可維護、可擴充的架構查詢狀態、掌握資料並完成日常作業。'
    ],
    sidebar: sharedSidebar,
    blocks: [
      {
        ...
        imageAlt: '工業營運平台與網頁開發介面示意',
        layout: 'image-right',
        title:
          '網頁開發的重點，是把工業資料與營運流程變成團隊真正能使用的數位平台',
        paragraphs: [
          '在工業場域中，網站不只是品牌展示頁，而是連接設備資料、告警事件、報表查詢、維運紀錄與管理流程的操作入口。好的網頁開發需要同時理解前端體驗、後端邏輯、資料流向與現場作業節奏。',
          '我們會先釐清資料來源、使用者角色、操作流程與系統整合方式，再設計瀏覽器端介面、後台模組與 API 架構，讓不同團隊能以一致、安全且容易維護的方式使用工業資料。'
        ],
        highlights: ['工業資料可視化', '前後端與系統整合', '支援長期維運與擴充']
      },
      {
        type: 'proof-strip',
        eyebrow: false,
        ...
        items: [
          {
            title: '工業情境導向架構',
            description:
              '依據現場流程、資料來源、使用角色與維運需求規劃網站架構，避免只以一般版型套用工業場景。'
          },
          {
            title: 'OT / IT 資料整合',
            description:
              '協助串接 SCADA、PI Server、Historians、告警、報表或既有後端系統，讓資料能在前台、後台與管理流程中被一致使用。'
          },
          {
            title: '可操作的資料介面',
            description:
              '將即時狀態、歷史趨勢、事件紀錄、查詢條件與報表輸出整理成清楚的介面，降低跨團隊使用資料的門檻。'
          },
          {
            title: '可維護與可擴充基礎',
            description:
              '以可讀的架構、版本控管、測試與部署流程建立平台基線，支援後續新增站點、語系、模組與系統整合。'
          }
        ]
      },
      {
        type: 'process-steps',
        eyebrow: '承接內容與做法',
        title: '從需求梳理到上線後維運一起規劃',
        items: [
          {
            stepLabel: '01',
            title: '需求梳理與系統邊界',
            description:
              '先確認使用者角色、現場流程、資料來源、既有系統與權限邊界，讓網站功能與實際營運需求對齊。'
          },
          {
            stepLabel: '02',
            title: '介面設計與響應式體驗',
            description:
              '規劃監控儀表板、資料查詢、清單、表單、報表與後台操作介面，讓桌機與行動裝置都能保持清楚一致。'
          },
          {
            stepLabel: '03',
            title: '前端與後端建置',
            description:
              '建置使用者介面、後端服務、資料模型、業務規則與管理模組，讓平台不只是畫面，而是可實際運作的系統。'
          },
          {
            stepLabel: '04',
            title: '資料視覺化與報表流程',
            description:
              '依據營運需求整理即時狀態、歷史趨勢、事件紀錄與查詢條件，支援更有效率的資料檢視與報表輸出。'
          },
          {
            stepLabel: '05',
            title: 'API 與工業系統整合',
            description:
              '依需求串接 SCADA / HMI、PI Server、Historians、告警系統、內部資料庫或其他企業系統，建立穩定的資料交換流程。'
          },
          {
            stepLabel: '06',
            title: '測試、部署與維運準備',
            description:
              '在上線前檢查資料正確性、權限流程、操作體驗與部署設定，並為後續維護、擴充與故障排查保留清楚基礎。'
          }
        ]
      },
      {
        ...
        items: [
          {
            title: '工業入口與後台管理',
            description:
              '將企業服務、系統入口、文件資訊、帳號權限、站點與設備設定整合成一致的瀏覽器端管理入口。'
          },
          {
            title: '監控儀表板',
            description:
              '呈現站點狀態、設備資訊、趨勢資料與關鍵指標，協助團隊快速掌握現況。'
          },
          {
            title: '資料查詢與報表平台',
            description:
              '整合 PI Server、Historians 或其他資料來源，支援歷史查詢、條件篩選與報表需求。'
          },
          {
            title: '告警與事件管理介面',
            description:
              '將告警、事件與處理流程集中呈現，降低人工追蹤與跨系統切換成本。'
          },
          {
            title: '通知串接與協作流程',
            description:
              '依告警、事件或作業流程串接 Microsoft Teams、LINE 或其他通知通道，讓關鍵訊息能主動送達負責團隊並保留處理脈絡。'
          },
          {
            title: '多語系與跨站點支援',
            description:
              '在一致架構下維護不同語系、不同場域與不同使用角色的內容與功能。'
          }
        ]
      },
      {
        ...
        title: '適合提早納入的情境',
        paragraphs: [
          '當企業需要把 SCADA / HMI、PI Server、Historians、告警資訊、報表資料或既有內部系統延伸成更容易使用的瀏覽器端平台時，就應該提早導入網頁開發規劃。',
          '越早確認資料來源、權限模型、操作流程與系統邊界，後續新增站點、擴充模組、整合資料與長期維護的成本就越容易被控制。'
        ]
      }
    ]
  }
